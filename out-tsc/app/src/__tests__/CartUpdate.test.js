...
jest.mock('../components/OrderHistory', () => () => _jsx("div", {}));
...
// --- Mock React Query ---
jest.mock('@tanstack/react-query', () => (Object.assign(Object.assign({}, jest.requireActual('@tanstack/react-query')), { useQuery: () => ({
        data: [
            {
                id: '1',
                title: 'Test Product',
...
describe('ShoppingCart Integration Test', () => {
    it('adds product to cart and updates UI', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        render(_jsx(Provider, { store: store, children: _jsxs(QueryClientProvider, { client: queryClient, children: [_jsx(Products, { selectedCategory: "" }), _jsx(ShoppingCart, {})] }) }));
